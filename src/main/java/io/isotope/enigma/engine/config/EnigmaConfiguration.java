...
public class EnigmaConfiguration {
    ...
    public WebClient keyManagementWebClient(EnigmaProperties properties) throws Exception {
        ...
        trustStore.load(EnigmaConfiguration.class.getClassLoader().getResourceAsStream("keymanagementclient.p12"), keyStorePass.toCharArray());
        keyStore = KeyStore.getInstance("pkcs12");
        keyStore.load(EnigmaConfiguration.class.getClassLoader().getResourceAsStream("keymanagementclient.p12"), keyStorePass.toCharArray());
